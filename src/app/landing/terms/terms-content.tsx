    ...
    >
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          By accessing or using Telaven Solutions (&quot;the Service&quot;), you agree to be bound by these Terms of Service. If you do not agree to these terms, you may not use the Service. These terms apply to all users, including visitors, registered users, and API consumers.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          Telaven Solutions is a enterprise technology platform that enables users to organize our platform actors into projects, schedule and manage runs, combine data from multiple runs into unified datasets, and access data via export or API. The Service includes the web dashboard, REST API, and all related tools and documentation.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed mb-3">
          Access to the Telaven Solutions API is governed by these terms and the following conditions:
        </p>
        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
      ...
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          You retain ownership of all data you collect through the Service. Telaven Solutions does not claim any intellectual property rights over your processed data. We store and process your data solely to provide the Service. You are responsible for ensuring that your data processing activities comply with applicable laws and the terms of the services you use.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          To the maximum extent permitted by law, Telaven Solutions shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or business opportunities, arising from your use of the Service. Our total liability shall not exceed the amount you paid for the Service in the twelve months preceding the claim.
        </p>
      </section>
