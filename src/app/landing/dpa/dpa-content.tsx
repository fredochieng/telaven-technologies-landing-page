    ...
    >
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
          ...
          <li>Data collected by Customer&apos;s enterprise technology actors, which may contain personal data depending on the Customer&apos;s use case</li>
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
          ...
          <li><strong>our platform:</strong> For executing enterprise technology actors as directed by the Customer</li>
        </ul>
      ...
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          For questions about this DPA or to request a signed copy, contact us at <a href="mailto:dpa@telaventechnologies.com" className="text-primary hover:underline">dpa@telaventechnologies.com</a> or through our <a href="/landing#contact" className="text-primary hover:underline">contact form</a>.
        </p>
      </section>
    </LegalPageLayout>
  )
